const omensList = [
  ...
  "Peep the horror.",
  "The game.",
  "Cut the third chorus.",
  "I heard it all again last night, the shimmer in your eyes.",
  "I never thought it'd be this soon.",
  "You're just a part of my life",
  "I can't stand it, it's brain poison.",
  "It's time to play in goo!",
  "Kill the hidden king!",
  "Promise me that you will do no harm",
  "We're so messy and complicated, But I think \"effortless\" is overrated!",
  "We walk in sync without a care for timing!",
  "Trangenner Chungus",
  "Hi",
  "Hi gobcord",
  "don't lose hope when the secrets show",
  "Urgent care is such a dying art",
  "Don't you want to feel seen? Don't you want to be heard?",
  "Does it please you to be everything that you see",
  "Does it burn you to be everything that you see",
  "I wonder what it feels like to keep you by my bedside",
